...
class MobileApplicationDeploymentServiceSubscriptionView(ModelView):
...
appbuilder.add_view(
    MobileApplicationDeploymentServiceSubscriptionView,
    "Deployment Mobile Application Subscriptions",
    icon="fa-cart-plus",
