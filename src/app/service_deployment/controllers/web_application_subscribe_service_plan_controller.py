...
from app.services.subscription_web_application_service import (
    SubscriptionWebApplicationDeploymentService,
)
...
class WebApplicationDeploymentSubscriptionApi(BaseApi):
    ...
    def subscribe_to_plan(self, **kwargs):
        ...
        try:
            # Initialize services
            subscription_web_application_deployment_service = (
                SubscriptionWebApplicationDeploymentService(db.session, _logger)
            )
            ...
            is_valid, error_msg, request_data = (
                subscription_web_application_deployment_service.validate_web_application_deployment_subscription_request(
                    data
                )
            )
            if not is_valid:
            ...
            # Create subscription
            subscription = subscription_web_application_deployment_service.create_web_application_deployment_subscription(
...
appbuilder.add_api(WebApplicationDeploymentSubscriptionApi)
