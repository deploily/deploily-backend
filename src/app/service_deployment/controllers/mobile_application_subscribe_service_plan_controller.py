...
from app.services.subscription_mobile_application_service import (
    SubscriptionMobileApplicationDeploymentService,
)
...
class MobileApplicationDeploymentSubscriptionApi(BaseApi):
    ...
    def subscribe_to_plan(self, **kwargs):
        ...
        try:
            # Initialize services
            subscription_mobile_application_deployment_service = (
                SubscriptionMobileApplicationDeploymentService(db.session, _logger)
            )
            ...
            is_valid, error_msg, request_data = (
                subscription_mobile_application_deployment_service.validate_mobile_application_deployment_subscription_request(
                    data
                )
            )
            if not is_valid:
            ...
            # Create subscription
            subscription = subscription_mobile_application_deployment_service.create_mobile_application_deployment_subscription(
...
appbuilder.add_api(MobileApplicationDeploymentSubscriptionApi)
